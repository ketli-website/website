...
$q=mysqli_query($con ,"SELECT * FROM assignment  where aid='$aid'") or die ("Error");
...
<div class="panel panel-default">
  <div class="panel-body">
<center> <p class="titles"><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>&nbsp;&nbsp;Suggested Assignment</p></center>
</div></div>
<?php 

if ($year==1)
{
$q=mysqli_query($con ,"SELECT * FROM assignment  where college_id='$college_id' and year='$year' ORDER BY rand() LIMIT 2 ") or die ("Error");
}
else
{
