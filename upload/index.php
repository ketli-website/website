...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="title" id="title" placeholder="Enter title of Test paper" required>
  </div>
...
<!--Upload Image-->
<div class="form-group">
    <label for="file">Upload&nbsp;Photo of Test paper (You can choose multiple photo at a time)<span style="color:red">*(Its Required)</span></label>
